...
import com.pengu.holestorage.tile.TileFluidInjector;

public final class BlockFluidInjector extends Block implements ITileEntityProvider
{
	...
	{
		super(Material.IRON);
		setUnlocalizedName("fluid_injector");
		setHardness(4);
