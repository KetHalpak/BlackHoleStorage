...
public final class BlockRFEjector extends Block implements ITileEntityProvider
{
	public static final PropertyEnum<EnumFacing> FACING = InfoBHS.FACING_UD;
	
	public BlockRFEjector()
	{
		super(Material.IRON);
		setUnlocalizedName("rf_ejector");
		setHardness(4);
